<div align="center">
  ...
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:7C3AED,50:06B6D4,100:0F172A&height=280&section=header&text=Marcos%20Firmino%20Rodrigues&fontSize=48&fontColor=FFFFFF&fontAlignY=36&desc=Desenvolvedor%20Back-end%20%7C%20Futuro%20Especialista%20em%20Cibersegurança&descAlignY=56&descSize=16&animation=fadeIn" width="100%" alt="Header Banner" />

  <br/>

  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com/?font=Fira+Code&size=19&duration=3000&pause=1000&color=06B6D4&center=true&vCenter=true&width=800&lines=Desenvolvedor+Back-end+em+Forma%C3%A7%C3%A3o;Python+%E2%80%A2+Django+%E2%80%A2+Java+%E2%80%A2+C%23+%E2%80%A2+Node.js+%E2%80%A2+PHP;Estagi%C3%A1rio+de+Suporte+T%C3%A9cnico+TI+na+Labstar;Foco+em+APIs+RESTful,+Arquitetura+de+Software+%26+SecOps" alt="Typing SVG" />
  </a>
  ...
  <img src="https://komarev.com/ghpvc/?username=marcos22-s&label=Visitas%20ao%20Perfil&color=06B6D4&style=flat-square" alt="Profile Views"/>
...
Sou **Marcos Firmino Rodrigues**, desenvolvedor focado no ecossistema **Back-end** e graduando em Desenvolvimento de Software Multiplataforma. Minha trajetória combina o rigor técnico da construção de **APIs RESTful e arquiteturas escaláveis** com uma atuação prática em **suporte técnico, infraestrutura, gerenciamento de redes e cibersegurança**.

Gosto de entender como os sistemas funcionam "debaixo do capô" — desde a chegada de uma requisição HTTP na camada de rede até a persistência otimizada no banco de dados e a mitigação de superfícies de ataque.

* 📍 **Localização:** Leme, São Paulo — Brasil
* 💼 **Posição Atual:** Estagiário de Suporte Técnico TI na **Labstar Tecnologia**
* 🎯 **Objetivo:** Consolidar atuação como Engenheiro Back-end e evoluir continuamente no domínio da **Cibersegurança & DevSecOps**.
...
### 🛡️ Cibersegurança, Redes & Infraestrutura
<p align="left">
...
## 🎓 Formação Acadêmica & Cursos de Especialização

### 🏛️ Educação Formal
* 🎓 **Graduação em Desenvolvimento de Software Multiplataforma** — *FATEC Araras* (Em andamento)
* 📜 **Técnico em Desenvolvimento de Sistemas** — *ETEC Salim Sedeh* (Concluído)

### 📜 Certificações & Cursos Extracurriculares
* 🛡️ **Fortinet Network Security Academy:** Cursos focados em fundamentos de segurança de redes, gerenciamento de firewalls e perímetros de proteção.
* ☁️ **Microsoft 365 / Entra ID:** Administração de usuários, gerenciamento de identidades, acessos e políticas de segurança em nuvem.
* 🌐 **Arquitetura de APIs RESTful:** Design, boas práticas de endpoints, autenticação via JWT e integração de microsserviços.
* 💻 **Lógica de Programação & Estruturas de Dados:** Aprofundamento em algoritmos avançados, Orientação a Objetos e Padrões de Projeto (Design Patterns).

---

## 💼 Experiência Profissional

#### 🛠️ **Estagiário de Suporte Técnico em TI** — *Labstar Tecnologia*
> *Atuação com suporte em nível de infraestrutura, redes, sistemas corporativos e atendimento ao usuário.*
* Atendimento e resolução de incidentes em hardware, software e redes de computadores.
* Suporte e administração em ambientes **Microsoft 365** e ferramentas de produtividade.
* Apoio na manutenção de políticas de segurança interna, gerenciamento de acessos e monitoramento de ativos.
